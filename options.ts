...
const voided_colors = {
    ...
    purple_10: '#edebfc',
    purple_11: '#f6f4fe',
    nix_blue_dark: '#4a6cae',
    nix_blue_light: '#7fb7e5',
};
...
const options = mkOptions(OPTIONS, {
    theme: {
        ...
        notification: {
            scaling: opt(100),
            background: opt(voided_colors.purple_1),
            opacity: opt(100),
            actions: {
                background: opt(voided_colors.purple_6),
                text: opt(voided_colors.purple_10),
            },
            label: opt(voided_colors.purple_8),
            border: opt(voided_colors.purple_4),
            border_radius: opt('0.6em'),
            time: opt(voided_colors.purple_6),
            text: opt(voided_colors.purple_10),
            labelicon: opt(voided_colors.purple_8),
            close_button: {
                background: opt(voided_colors.purple_10),
                label: opt(voided_colors.purple_1),
            },
        },
        osd: {
            scaling: opt(100),
        ...
        bar: {
            ...
            buttons: {
                ...
                enableBorders: opt(true),
                borderSize: opt('0.05em'),
                ...
                background_hover_opacity: opt(70),
                ...
                dashboard: {
                    background: opt(voided_colors.nix_blue_dark),
                    enableBorder: opt(false),
                    border: opt(voided_colors.nix_blue_light),
                    icon: opt(voided_colors.nix_blue_light),
                    spacing: opt('0.5em'),
                },
                workspaces: {
                    background: opt(voided_colors.purple_2),
                    enableBorder: opt(false),
                    smartHighlight: opt(true),
                    border: opt(voided_colors.purple_8),
                    available: opt(voided_colors.purple_6),
                    occupied: opt(voided_colors.purple_7),
                    active: opt(voided_colors.purple_8),
                    hover: opt(voided_colors.purple_10),
                ...
                windowtitle: {
                    ...
                    enableBorder: opt(false),
                    border: opt(voided_colors.purple_8),
                    text: opt(voided_colors.purple_7),
                    icon: opt(voided_colors.purple_7),
                    icon_background: opt(voided_colors.purple_8),
                    spacing: opt('0.5em'),
                },
                media: {
                    background: opt(voided_colors.purple_2),
                ...
                notifications: {
                    ...
                    background: opt(voided_colors.nix_blue_dark),
                    icon: opt(voided_colors.nix_blue_light),
                    icon_background: opt(voided_colors.nix_blue_dark),
            ...
            menus: {
                ...
                border: {
                    size: opt('0.13em'),
                    radius: opt('0.7em'),
                    color: opt(voided_colors.purple_8),
                },
                ...
                menu: {
                    media: {
                        scaling: opt(100),
                        song: opt(voided_colors.purple_8),
                        artist: opt(voided_colors.purple_7),
                        album: opt(voided_colors.purple_6),
                        background: {
                            color: opt(voided_colors.purple_1),
                        },
                        card: {
                            color: opt(voided_colors.purple_1),
                            tint: opt(85),
                        ...
                        buttons: {
                            inactive: opt(voided_colors.purple_1),
                            enabled: opt(voided_colors.purple_6),
                            background: opt(voided_colors.purple_8),
                            text: opt(voided_colors.purple_1),
                        },
                        slider: {
                            primary: opt(voided_colors.purple_7),
                            background: opt(voided_colors.purple_2),
                            backgroundhover: opt(voided_colors.purple_1_5),
                            puck: opt(voided_colors.purple_4),
                        },
                    },
                    volume: {
                        scaling: opt(100),
                        card: {
                            color: opt(voided_colors.purple_2),
                        },
                        background: {
                            color: opt(voided_colors.purple_1),
                        },
                        ...
                        text: opt(voided_colors.purple_7),
                        listitems: {
                            passive: opt(voided_colors.purple_9),
                            active: opt(voided_colors.purple_7),
                        },
                        iconbutton: {
                            passive: opt(voided_colors.purple_9),
                            active: opt(voided_colors.purple_7),
                    ...
                    network: {
                        ...
                        text: opt(voided_colors.purple_7),
                        status: {
                            color: opt(voided_colors.purple_6),
                        },
                        listitems: {
                            passive: opt(voided_colors.purple_9),
                            active: opt(voided_colors.purple_7),
                        ...
                        switch: {
                            enabled: opt(voided_colors.purple_7),
                            disabled: opt(voided_colors.purple_3),
                            puck: opt(voided_colors.purple_4),
                        },
                    },
                    bluetooth: {
                        ...
                        text: opt(voided_colors.purple_7),
                        status: opt(voided_colors.purple_6),
                        switch_divider: opt(voided_colors.purple_8),
                        switch: {
                            enabled: opt(voided_colors.purple_7),
                            disabled: opt(voided_colors.purple_3),
                            puck: opt(voided_colors.purple_4),
                    ...
                    systray: {
                        dropdownmenu: {
                            background: opt(voided_colors.purple_1),
                            text: opt(voided_colors.purple_8),
                            divider: opt(voided_colors.purple_2),
                        },
                    },
                    battery: {
                        scaling: opt(100),
                    ...
                    clock: {
                        ...
                        text: opt(voided_colors.purple_8),
                        time: {
                            time: opt(voided_colors.purple_8),
                            timeperiod: opt(voided_colors.purple_6),
                        },
                        calendar: {
                            yearmonth: opt(voided_colors.purple_7),
                            weekdays: opt(voided_colors.purple_8),
                            paginator: opt(voided_colors.purple_7),
                            currentday: opt(voided_colors.purple_8),
                            days: opt(voided_colors.purple_9),
                            contextdays: opt(voided_colors.purple_6),
                        },
                        weather: {
                            icon: opt(voided_colors.purple_9),
                            temperature: opt(voided_colors.purple_7),
                            status: opt(voided_colors.purple_8),
                            stats: opt(voided_colors.purple_9),
                            thermometer: {
                                extremelyhot: opt(voided_colors.purple_10),
                                hot: opt(voided_colors.purple_9),
                                moderate: opt(voided_colors.purple_8),
                                cold: opt(voided_colors.purple_7),
                                extremelycold: opt(voided_colors.purple_6),
                            },
                            hourly: {
                                time: opt(voided_colors.purple_7),
                                icon: opt(voided_colors.purple_7),
                                temperature: opt(voided_colors.purple_7),
                            },
                        },
                    ...
                    dashboard: {
                        ...
                        profile: {
                            name: opt(voided_colors.purple_8),
                            size: opt('8.5em'),
                            radius: opt('0.4em'),
                        },
                        powermenu: {
                            shutdown: opt(voided_colors.purple_6),
                            restart: opt(voided_colors.purple_6),
                            logout: opt(voided_colors.purple_6),
                            sleep: opt(voided_colors.purple_6),
                            confirmation: {
                                card: opt(colors.base),
                                background: opt(voided_colors.purple_1),
                                border: opt(voided_colors.purple_8),
                                label: opt(voided_colors.purple_7),
                                body: opt(voided_colors.purple_8),
                                confirm: opt(colors.green),
                                deny: opt(colors.red),
                                button_text: opt(voided_colors.purple_1),
                            },
                        },
                        shortcuts: {
                            background: opt(voided_colors.purple_7),
                            text: opt(voided_colors.purple_1),
                        ...
                        monitors: {
                            bar_background: opt(voided_colors.purple_1),
                            cpu: {
                                icon: opt(voided_colors.purple_7),
                                bar: opt(voided_colors.purple_6),
                                label: opt(voided_colors.purple_7),
                            },
                            ram: {
                                icon: opt(voided_colors.purple_7),
                    ...
                    notifications: {
                        ...
                        height: opt('58em'),
                        label: opt(voided_colors.purple_8),
                        no_notifications_label: opt(voided_colors.purple_5),
                        background: opt(voided_colors.purple_1),
                        card: opt(voided_colors.purple_2),
                        border: opt(voided_colors.purple_8),
                        switch_divider: opt(voided_colors.purple_8),
                        clear: opt(voided_colors.purple_10),
                        switch: {
                            enabled: opt(voided_colors.purple_7),
                            disabled: opt(voided_colors.purple_3),
                            puck: opt(voided_colors.purple_4),
                        ...
                        pager: {
                            show: opt(true),
                            background: opt(voided_colors.purple_3),
                            button: opt(voided_colors.purple_10),
                            label: opt(voided_colors.purple_3),
                        },
                        scrollbar: {
                            color: opt(voided_colors.purple_8),
                            width: opt('0.35em'),
